...
export class TokenManipulationTools {
  ...
  async handleMoveToken(args: any): Promise<any> {
    ...
    try {
      const result = await this.foundryClient.query('foundry-forge-mcp.move-token', {
        tokenId,
        x,
        y,
        animate,
  ...
  async handleUpdateToken(args: any): Promise<any> {
    ...
    try {
      const result = await this.foundryClient.query('foundry-forge-mcp.update-token', {
        tokenId,
        updates,
      });
  ...
  async handleDeleteTokens(args: any): Promise<any> {
    ...
    try {
      const result = await this.foundryClient.query('foundry-forge-mcp.delete-tokens', {
        tokenIds,
      });
  ...
  async handleGetTokenDetails(args: any): Promise<any> {
    ...
    try {
      const tokenData = await this.foundryClient.query('foundry-forge-mcp.get-token-details', {
        tokenId,
      });
  ...
  async handleToggleTokenCondition(args: any): Promise<any> {
    ...
    try {
      const result = await this.foundryClient.query('foundry-forge-mcp.toggle-token-condition', {
        tokenId,
        conditionId,
        active,
      });
  ...
  async handleGetAvailableConditions(args: any): Promise<any> {
    ...
    try {
      const result = await this.foundryClient.query('foundry-forge-mcp.get-available-conditions', {});
